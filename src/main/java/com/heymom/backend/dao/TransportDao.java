...
import com.heymom.backend.entity.location.Transport;

public interface TransportDao extends BaseDao<Transport, Integer> {
	@Query("from Transport where startTransitStation.id=(:startStationId) and endTransitStation.id=(:endStationId)")
